...
use app\admin\model\community\Comment as CommentM;
...
class Comment extends Controller
{
    public function getList()
    {
        ...
        $list = $CommentM->where($sql)->order($order)->paginate($params->size, false, [
            'page' =>  $params->page,
        ]);
    ...
    public function getOneByID()
    {
        ...
        if ($params == [] || $params['id'] == '') {
            ...
            $CommentM = new CommentM();
            $interaction = $CommentM->where('id', $params['id'])->find();
            if ($interaction) {
                $result = array(
                    'data' => $interaction,
                    'code' => 1,
    ...
    public function deleteOne()
    {
        ...
        CommentM::where('id', $params['id'])->delete();
        $result = array(
            'data' => null,
            'code' => 1,
            'msg' => "删除成功"
