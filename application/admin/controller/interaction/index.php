...
class Index extends Controller
{
    public function getList()
    {
        ...
        $list = $InteractionM->where($sql)->order($order)->paginate($params->size, false, [
            'page' =>  $params->page,
        ]);
    ...
    public function getOneByID()
    {
        ...
        if ($params == [] || $params['id'] == '') {
            ...
            $InteractionM = new InteractionM();
            $interaction = $InteractionM->where('id', $params['id'])->find();
            if ($interaction) {
                $result = array(
                    'data' => $interaction,
                    'code' => 1,
    ...
    public function deleteOne()
    {
        ...
        InteractionM::where('id', $params['id'])->delete();
        $result = array(
            'data' => null,
            'code' => 1,
            'msg' => "删除成功"
